...
// creation, save/load screens, the death scene, and any other state where
// the player data is not authoritative. The world map is real gameplay
// and returns true.
//
...
//   4. `map_data.name[0] != '\\0' || worldMapIsActive()`
//                                       (a real map is loaded, OR the
//                                        world map is the active surface)
